module.exports = [
"[project]/content/profile.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const profile = {
    ...
    tagline: "I build reliable web apps and the systems behind them, from polished UIs to APIs, queues, and blockchain-backed verification.",
    location: "Philippines",
    email: "rodericksalise813@gmail.com",
    links: [
        {
            label: "GitHub",
            href: "https://github.com/Tofuwuuu"
        },
        {
            label: "LinkedIn",
...
function OpenGraphImage() {
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$og$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ImageResponse"](/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        style: {
            ...
            padding: "72px",
            background: "radial-gradient(900px circle at 18% 18%, rgba(124,92,255,0.35), rgba(0,0,0,0) 60%), radial-gradient(900px circle at 85% 10%, rgba(255,255,255,0.12), rgba(0,0,0,0) 60%), #0b0d12",
            color: "#e6e9f2"
        },
        children: [
...
async function __TURBOPACK__default__export__(props) {
    ...
    function getImageMetadata(imageMetadata, idParam) {
        const data = {
            ...
            url: imageUrl + (idParam ? '/' + idParam : '') + '?' + "8bae6f08afe70fc3"
        };
...
//# sourceMappingURL=_0c6s4o8._.js.map